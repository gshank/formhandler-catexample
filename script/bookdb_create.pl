...
bookdb_create.pl [options] model|view|controller name [helper] [options]
 ...
 Examples:
   ...
   bookdb_create.pl -mechanize controller My::Controller
   bookdb_create.pl view My::View
   bookdb_create.pl view MyView TT
   bookdb_create.pl view TT TT
   bookdb_create.pl model My::Model
   bookdb_create.pl model SomeDB DBIC::Schema MyApp::Schema create=dynamic\
   dbi:SQLite:/tmp/my.db
   bookdb_create.pl model AnotherDB DBIC::Schema MyApp::Schema create=static\
